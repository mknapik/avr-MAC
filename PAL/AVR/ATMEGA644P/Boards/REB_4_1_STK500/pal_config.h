 ...
 * UART1 must not be used, since the pin PD2 required for
 * RXD1 is used for INT0 for the transceiver main IRQ.
 */
/* Data Length is 8 bit */
#define UART_0_INIT_NON_GENERIC()   (UCSR0C = (1 << UCSZ01) | (1 << UCSZ00))
#define UART_1_INIT_NON_GENERIC()   /* Must not be used for this board. */
