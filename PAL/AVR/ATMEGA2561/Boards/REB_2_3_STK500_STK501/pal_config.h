 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for ATmega2561
 *
 * This header file contains configuration parameters for ATmega2561.
 *
...
/*
 * TRX Access macros for ATmega2561
 */
...
#define TRX_INIT()                      do {                        \
     ...
     * For Example for ATmega2561, FOSC = 8Mhz                      \
