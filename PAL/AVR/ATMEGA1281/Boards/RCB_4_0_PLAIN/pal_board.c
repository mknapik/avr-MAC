/**
 * @file PAL/AVR/ATMEGA1281/Boards/RCB_4_0_PLAIN/pal_board.c
 *
 * @brief Board specific functions for RCB_4_0_PLAIN with ATmega1281 and AT86RF231
 *
 ...
 *
 * @param led_no led_no LED ID
 * @param led_setting led_setting LED_ON, LED_OFF, LED_TOGGLE
 */
