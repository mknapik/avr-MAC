...
#if (BOARD_TYPE == RCB_4_1_SENS_TERM_BOARD)
 ...
 * TRX Initialization
 */
#if ((F_CPU == (8000000UL)) || (F_CPU == (4000000UL)))
    #define TRX_INIT()                      do {                        \
         ...
         * FOSC = 8Mhz: SPI clock is set to (8/4)*2 = 4 Mhz             \
         * FOSC = 4Mhz: SPI clock is set to (4/4)*2 = 2 Mhz             \
         */                                                             \
