/**
 * @file PAL/AVR/ATMEGA1281/Boards/RCB_3_2_BREAKOUT_BOARD/pal_irq.c
 *
 * @brief IRQ specific functions for RCB_3_2_BREAKOUT_BOARD with ATmega1281 and AT86RF230B
 *
 * This file contains functions to initialize, enable, disable and install
 * handler for the transceiver interrupts.
 *
 * $Id: pal_irq.c 21902 2010-04-26 14:36:17Z sschneid $
 *
