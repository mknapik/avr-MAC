/**
 * @file PAL/AVR/ATMEGA1281/Boards/RCB_3_2_BREAKOUT_BOARD/pal_config.h
 *
 * @brief PAL configuration for RCB_3_2_BREAKOUT_BOARD with ATmega1281 and AT86RF230B
 *
 * This header file contains configuration parameters for the board
 * RCB_3_2_BREAKOUT_BOARD with ATmega1281 and AT86RF230B.
 *
...
/**
 * @defgroup grpPal_AT86RF230B_ATMEGA1281_RCB_3_2_BREAKOUT_BOARD \
 *           RCB230 V3.2 with ATmega1281 and AT86RF230 \
 *           based on Breakout board
 *
 ...
 * RCB_3_2_BREAKOUT_BOARD with ATmega1281 and AT86RF230B.
 *
 * The board RCB_3_2_BREAKOUT_BOARD with ATmega1281 and AT86RF230B provides an
 ...
 *
 * This board provides one UART channel UART_1.
 * See @ref UART_1_INIT_NON_GENERIC.
 *
 *
...
#if (BOARD_TYPE == RCB_3_2_BREAKOUT_BOARD)

/**
 * \addtogroup grpPal_AT86RF230B_ATMEGA1281_RCB_3_2_BREAKOUT_BOARD
 * @{
 */
