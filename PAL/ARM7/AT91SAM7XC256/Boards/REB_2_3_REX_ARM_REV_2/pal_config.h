 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for AT91SAM7XC256
 *
 * This header file contains configuration parameters for AT91SAM7XC256.
 *
 * $Id: pal_config.h 22269 2010-06-17 06:25:07Z sschneid $
 *
 */
/**
 * @author
...
/*
 * Indentifiers for PIO's in AT91SAM7XC256
 */
...
/* The pin on AT91SAM7XC256 to which the transceiver interrupt is connected. */
#define TRX_INTERRUPT_PIN               (AT91C_PA30_IRQ0)


/*
 *  Macros dealing with AIC of AT91SAM7XC256
 */
...
/*
 * Macros dealing with the global interrupt (IRQ bit) of AT91SAM7XC256.
 */
...
/*
 * Timer macros for AT91SAM7XC256
 */
...
/*
 * TRX Access macros for AT91SAM7XC256
 */
...
/*
 * LED pins on the AT91SAM7XC256 board
 */
#define LED_PINS                (AT91C_PIO_PB19 | AT91C_PIO_PB20 | \
                                 AT91C_PIO_PB21 | AT91C_PIO_PB22)

/*
 * 5-way Joystick on the AT91SAM7XC256 board
