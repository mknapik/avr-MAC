 ...
 */
#define LED_ADDR_0                AT91C_PIO_PB0
#define LED_ADDR_1                AT91C_PIO_PA18

/*
 * Button pins on the AT91SAM7X512 board
 */
#define BUTTON_ADDR_1             AT91C_PIO_PB0


/*
 * access to real STB-hardware via address lines and decoder circuitry
 */
#define DMUX_PIN_0                AT91C_PIO_PA4
#define DMUX_PIN_1                AT91C_PIO_PB25
#define WR_PIN                    AT91C_PIO_PB19
#define RD_PIN                    AT91C_PIO_PA14


#ifdef USB0

/* tell pal.c to call usb_handler() regularly */
#define USE_FTDI_USB              (1)

/*
 * FTDI based USB Portpins
 */
#define USB_ADDR_PIN_0            AT91C_PIO_PB0
#define USB_ADDR_PIN_1            AT91C_PIO_PA18
#define USB_ADDR_PIN_2            AT91C_PIO_PA17
#define USB_ADDR_PIN_3            AT91C_PIO_PA16
#define USB_ADDR_PIN_4            AT91C_PIO_PB6
#define USB_ADDR_PIN_5            AT91C_PIO_PB15
#define USB_ADDR_PIN_6            AT91C_PIO_PB8
#define USB_ADDR_PIN_7            AT91C_PIO_PB18

#define USB_RXF_PIN               AT91C_PIO_PB7
#define USB_TXE_PIN               AT91C_PIO_PB5
