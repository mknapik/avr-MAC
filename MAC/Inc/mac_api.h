 ...
 *
 * $Id: mac_api.h 21886 2010-04-26 13:39:56Z sschneid $
 *
...
/* Structure implementing the MAC Security related test PIB attributes */
typedef struct mac_sec_test_pib_tag
{
    /**
     * The test PIB attribute for enabling the default security key.
     */
    bool DefaultKeyEnable;

    /**
     * The test PIB attribute for holding the default key.
     */
 ...
 */
#if defined(MAC_SECURITY_ZIP) || defined(DOXYGEN)
