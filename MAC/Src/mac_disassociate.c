 ...
 *
 * $Id: mac_disassociate.c 23031 2010-08-20 12:33:46Z sschneid $
 *
...
void mlme_disassociate_request(uint8_t *m)
{
    ...
    /* Now build the actual disassociation command frame. */
    {
        ...
        *frame_ptr = disassoc_req.DisassociateReason;
        ...
        {
            frame_ptr -= 2;
            convert_16_bit_to_byte_array(disassoc_req.DeviceAddress, frame_ptr);
        }
        else
        {
            frame_ptr -= 8;
                            ...
                            uint8_t status)
{
    ...
    {
        temp_dev_addr = convert_byte_array_to_16_bit(&(frame_ptr->mpdu[PL_POS_DST_ADDR_START]));
    }
    else
    {
